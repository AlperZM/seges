<?php
/**
 * Seges One FSE: Block Patterns
 * Registers block patterns and categories.
 */
function seges_one_fse_register_block_patterns() {
	$block_pattern_categories = array(
		'featured' => array( 'label' => __( 'Featured', 'seges_one_fse' ) ),
		'footer'   => array( 'label' => __( 'Footers', 'seges_one_fse' ) ),
		'header'   => array( 'label' => __( 'Headers', 'seges_one_fse' ) ),
		'query'    => array( 'label' => __( 'Query', 'seges_one_fse' ) ),
		'pages'    => array( 'label' => __( 'Pages', 'seges_one_fse' ) ),
	);
	 ...
	 * }
	 */
	$block_pattern_categories = apply_filters( 'seges_one_fse_block_pattern_categories', $block_pattern_categories );
	 ...
	 */
	$block_patterns = apply_filters( 'seges_one_fse_block_patterns', $block_patterns );

	foreach ( $block_patterns as $block_pattern ) {
		$pattern_file = get_theme_file_path( '/inc/patterns/' . $block_pattern . '.php' );

		register_block_pattern(
			'seges_one_fse/' . $block_pattern,
			require $pattern_file
		);
	}
}
add_action( 'init', 'seges_one_fse_register_block_patterns', 9 );
