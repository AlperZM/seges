 ...
 */
return array(
	'title'      => __( 'Blog footer', 'seges_one_fse' ),
	...
	'content'    => '<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"var(--wp--custom--spacing--large, 8rem)","bottom":"var(--wp--custom--spacing--large, 8rem)"}}},"layout":{"inherit":true}} -->
					...
					<!-- wp:paragraph -->
					<p>' . esc_html__( 'Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet.', 'seges_one_fse' ) . '</p>
					<!-- /wp:paragraph --></div>
					<!-- /wp:column -->

					<!-- wp:column -->
					<div class="wp-block-column"><!-- wp:paragraph  -->
					<p>' . esc_html__( 'Latest posts', 'seges_one_fse' ) . '</p>
					<!-- /wp:paragraph -->
					...
					<!-- wp:column -->
					<div class="wp-block-column"><!-- wp:paragraph -->
					<p>' . esc_html__( 'Categories', 'seges_one_fse' ) . '</p>
					<!-- /wp:paragraph -->
