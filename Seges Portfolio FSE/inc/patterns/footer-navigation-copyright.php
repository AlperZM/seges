 ...
 */
return array(
	'title'      => __( 'Footer with navigation and copyright', 'seges_portfolio_fse' ),
	...
	'content'    => '<!-- wp:group {"align":"full","layout":{"inherit":true}} -->
					...
					<p class="has-text-align-center" style="font-size:16px">' . esc_html__( '© Site Title', 'seges_portfolio_fse' ) . '</p>
					<!-- /wp:paragraph --></div>
					<!-- /wp:group --></div>
					<!-- /wp:group -->',
);
